...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__KilloughDrive : PyBasefrc__KilloughDrive<PyTrampolineBase, CxxBase> {
    using PyBasefrc__KilloughDrive<PyTrampolineBase, CxxBase>::PyBasefrc__KilloughDrive;
