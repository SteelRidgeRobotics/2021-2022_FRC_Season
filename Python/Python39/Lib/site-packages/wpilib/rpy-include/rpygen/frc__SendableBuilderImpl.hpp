...
template <typename PyTrampolineBase, typename CxxBase = PyTrampolineBase>
struct Pyfrc__SendableBuilderImpl : PyBasefrc__SendableBuilderImpl<PyTrampolineBase, CxxBase> {
    using PyBasefrc__SendableBuilderImpl<PyTrampolineBase, CxxBase>::PyBasefrc__SendableBuilderImpl;



#ifndef RPYGEN_DISABLE_GetTable_v
    std::shared_ptr<nt::NetworkTable > GetTable() override {
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(std::shared_ptr<nt::NetworkTable >), CxxBase, "getTable", GetTable,);    }
#endif

#ifndef RPYGEN_DISABLE_SetSmartDashboardType_KRTTwine
    void SetSmartDashboardType(const wpi::Twine& type) override {
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "setSmartDashboardType", SetSmartDashboardType,type);    }
#endif

#ifndef RPYGEN_DISABLE_SetActuator_b
    void SetActuator(bool value) override {
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "setActuator", SetActuator,value);    }
#endif

#ifndef RPYGEN_DISABLE_SetSafeState_Tfunction_void___
    void SetSafeState(std::function<void ( )> func) override {
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "setSafeState", SetSafeState,func);    }
#endif

#ifndef RPYGEN_DISABLE_SetUpdateTable_Tfunction_void___
    void SetUpdateTable(std::function<void ( )> func) override {
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "setUpdateTable", SetUpdateTable,func);    }
#endif

#ifndef RPYGEN_DISABLE_GetEntry_KRTTwine
    nt::NetworkTableEntry GetEntry(const wpi::Twine& key) override {
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(nt::NetworkTableEntry), CxxBase, "getEntry", GetEntry,key);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addBooleanProperty", AddBooleanProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addDoubleProperty", AddDoubleProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addStringProperty", AddStringProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addBooleanArrayProperty", AddBooleanArrayProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addDoubleArrayProperty", AddDoubleArrayProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addStringArrayProperty", AddStringArrayProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addRawProperty", AddRawProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addValueProperty", AddValueProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addSmallStringProperty", AddSmallStringProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addSmallBooleanArrayProperty", AddSmallBooleanArrayProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addSmallDoubleArrayProperty", AddSmallDoubleArrayProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addSmallStringArrayProperty", AddSmallStringArrayProperty,key, getter, setter);    }
#endif
...
PYBIND11_OVERRIDE_NAME(PYBIND11_TYPE(void), CxxBase, "addSmallRawProperty", AddSmallRawProperty,key, getter, setter);    }
#endif
